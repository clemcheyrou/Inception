...
if ! wp core is-installed --allow-root  ; then
	...
	wp config create --dbname=$MYSQL_DATABASE --dbuser=$MYSQL_ROOT_USER--dbpass=$MYSQL_ROOT_PASSWORD --dbhost="mariadb:3306" --path='/var/www/wordpress'--allow-root --skip-check
